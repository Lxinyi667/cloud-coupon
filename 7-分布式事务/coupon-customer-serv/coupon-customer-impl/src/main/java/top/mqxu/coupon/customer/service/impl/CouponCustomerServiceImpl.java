package top.mqxu.coupon.customer.service.impl;
...
import top.mqxu.coupon.customer.converter.CouponConverter;
import top.mqxu.coupon.customer.dao.entity.Coupon;
import top.mqxu.coupon.customer.feign.CalculationService;
import top.mqxu.coupon.customer.feign.TemplateService;
...
import top.mqxu.coupon.customer.dao.CouponDao;
...
//        couponDao.deleteCouponInBatch(templateId,CouponStatus.INACTIVE);
    ...
    public Map<Long,CouponTemplateInfo> getTemplateInfoMap(Collection<Long> ids){
        ...
        return templates.stream().map(CouponTemplateConvertoer::convertToTemplateInfo).collect(Collectors.toMap(CouponTemplateInfo::))
    }
}